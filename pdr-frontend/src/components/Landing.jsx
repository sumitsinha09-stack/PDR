          ...
          <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
            <div className="lg:col-span-7">
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <a href="https://github.com/sumitsinha09-stack/PDR-publishing" target="_blank" rel="noopener noreferrer" className="bg-surface-container-high text-on-surface dark:text-slate-200 px-8 py-4 rounded-lg text-lg font-bold ghost-border active:scale-95 transition-transform text-center inline-block">
                  Documentation
                </a>
              </div>
            </div>
